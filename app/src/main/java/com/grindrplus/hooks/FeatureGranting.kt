...
class FeatureGranting : Hook(
    ...
    private fun initFeatures() {
        ...
        featureManager.add(Feature("CookieTap", GrindrPlus.cloneSettings.enable_cookie_tap))
        featureManager.add(Feature("VipFlag", GrindrPlus.cloneSettings.enable_vip_flag))
        ...
        featureManager.add(Feature("enable-mutual-taps-no-paywall", !(GrindrPlus.cloneSettings.enable_interest_section)))
    }
}